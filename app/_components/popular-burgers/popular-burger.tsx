...
const burgers: BurgerType[] = [
  {
    ...
    rate: 6,
    price: 350.0,
    desc: "لورم ایپسوم متن ساختگی با تولید سادگی و با استفاده از طراحان گرافیک است",
  },
  {
    image: "/images/b2.png",
    title: "همبرگر",
  ...
  return (
    <>
      ...
      <Swiper
        ...
        spaceBetween={15}
        navigation={false}
        className="w-[380px] rounded-2xl gap-5 p-2 mx-auto mt-8 mb-14 flex justify-center items-center md:w-[80%] lg:w-[80%] sm:w-[90%]"
        autoplay={{

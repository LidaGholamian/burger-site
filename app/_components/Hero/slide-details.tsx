    ...
    <div className="flex justify-center items-center mx-auto gap-10 w-[100%] xl:gap-14 md:pl-14 lg:pl-14 xl:pl-14 md:pb-24 lg:pb-24 xl:pb-24 pt-5">
      <figure>
        <Image
          ...
          height={1000}
          alt="slider-pics"
          className="w-[1000px] md:w-[1000px] lg:w-[1000px] xl:w-[1000px] h-auto pr-5"
        />
      </figure>
      <div className="flex flex-col justify-center items-start gap-5 w-[50%] md:w-[55%] lg:w-[65%] xl:w-[65%] text-white pr-10">
